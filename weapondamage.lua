print("^2Weapon Damage System ^7v^42^7.^43^7.^41 ^7- ^2Damage System by ^1Geshata^7")
CreateThread(function()
    ...
    SetWeaponDamageModifier(`weapon_hit_by_water_cannon`,0.1)
    SetWeaponDamageModifier(`weapon_fireextinguisher`, 0.1)
end)
